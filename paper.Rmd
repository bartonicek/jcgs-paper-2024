...
#| Bottom row: layering, created with `ggplot2` 
#| [@wickham2010; the source of the underlying data is the U.S. fuel economy data set, @mpg2024]."
#| message: false
#| warning: false
...
```{r}
#| echo: false
#| fig-cap: "\\label{fig:magritte}The representation of a thing is not the thing itself. 
#| Left: The Treachery of Images by René Magritte [-@magritte1929] makes the point that a painting of a pipe is not a pipe. 
#| Right: similarly, an image filled with coloured rectangles is not a barplot, 
#| unless the rectangles accurately represent some underlying data."
#| fig-height: 2.5
#| fig-show: "hold"
...
p1 <- p0 + 
  ...
  labs(title = "Valid representation")
...
p2 <- p0 + 
  ...
  geom_polygon(data = chull2, lty = "dashed", 
               col = "white", fill = NA) +
  labs(title = "Not a valid representation")
